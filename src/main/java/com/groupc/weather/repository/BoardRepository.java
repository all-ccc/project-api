...
"FROM Board B, User U,Comment C,likey L " +
"Where B.user_number = U.user_number AND B.board_number = L.board_number AND B.board_number = C.board_number AND B.user_number = :user_number " +
"GROUP BY B.board_number " +
...
"count(L.user_number) AS likeCount " +
"FROM Board B, User U,Comment C,likey L " +
"Where B.user_number = U.user_number AND B.board_number = L.board_number AND B.board_number = C.board_number " +
"GROUP BY B.board_number " +
